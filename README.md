...
1. Download the latest release from another machine: [ekumen-v1.7.1.tar.gz](https://github.com/aydinguven/ekumen/releases/latest/download/ekumen-v1.7.1.tar.gz)
